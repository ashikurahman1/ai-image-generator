...
// Calculate width/ height based on chosen ration
const getImageDimensions = (aspectRatio, baseSize = 512) => {
  ...
  // Ensure dimensions are multiplies of 16 (AI model requirements)
  calculatedWidth = Math.floor(calculatedHeight / 16) * 16;
